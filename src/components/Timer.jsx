...
const Timer = () => {
  ...
  return (
    ...
    <div className={Styles.input}>
      ...
      <input className={Styles.second} placeholder="S" maxLength="2" onChange={(e) => {setSec(e.target.value)}}/>
    </div>
    ...
    <div className={Styles.time}>
      ...
      <button className={Styles.start} disabled={stop == "disable" ? true : false}  onClick={() => handletimer()}>Start</button>
      <button className={Styles.stop} disabled={stop == "enable" ? true : false}  onClick={() => handlestop()}>Stop</button>
